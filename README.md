...
Чтобы запустить его локально, нужно выполнить команду 'streamlit run app.py' в терминале в той же папке, где находится файл file_1.py.
После этого увидим ![локальный URL](/primer_1.jpg)
